...
void BMA400::SetWakeupInterruption(uint8_t thr, uint8_t n_samples) {
  ...
  SPIwriteOneRegister(BMA400_WKUP_INT_CONFIG0,0x07 << 5 | n_samples << 2 | 0x01);
  SPIwriteOneRegister(BMA400_WKUP_INT_CONFIG1, thr); //  50 mg threshold for wake on any axis, n x 6.25 mgs at 2 g FS--------
