...
void setup() {
  ...
  for (int cal_int = 0; cal_int < 3000 ; cal_int ++){     //200        //Run this code 2000 times
...
void loop(){
  ...
  accx = (acc_x-2050)/16384.0;
  accy = (acc_y-77)/16384.0;
  accz = (acc_z-1947)/16384.0;
  acc_total_vector = sqrt((acc_x*acc_x)+(acc_y*acc_y)+(acc_z*acc_z));  //Calculate the total accelerometer vector
  float acc_total = pow(pow((accx),2)+pow((accy),2)+pow((accz),2),0.5);
  acc_total = acc_total * 10;
