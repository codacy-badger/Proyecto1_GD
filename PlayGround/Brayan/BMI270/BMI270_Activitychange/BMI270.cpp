...
//
void BMI270::SetAnyMotInt(byte Threshold , byte duration){
  SPIwriteOneRegister(0x3C,1<<15|1<<14|1<<13|duration);   // Set change_Activity_Interruption
  SPIwriteOneRegister(0x3E,1<<15|0x06<<11|Threshold); //Set threshold 
  }
//
...
void BMI270::SPIwriteRegisters(byte regAddress, const uint8_t *data, uint16_t len) {
  digitalWrite(BMI270_slaveSelectPin, LOW); // Put Cs bit in low mode
