...
//Set Auto Full Scale
#define BMA400_AFS_2G           0x00
#define BMA400_AFS_4G           0x01
#define BMA400_AFS_8G           0x02
#define BMA400_AFS_16G          0x03

//SR Sensor Rate
#define BMA400_SR_12_5Hz        0x05  // 12.5 Hz sample rate, etc
#define BMA400_SR_25Hz          0x06
#define BMA400_SR_50Hz          0x07
#define BMA400_SR_100Hz         0x08
#define BMA400_SR_200Hz         0x09  // 200 Hz sample rate
#define BMA400_SR_400Hz         0x0A
#define BMA400_SR_800Hz         0x0B  // 800 Hz sample rate

//Power modes
#define BMA400_sleep_Mode       0x00
#define BMA400_lowpower_Mode    0x01
#define BMA400_normal_Mode      0x02

// define oversampling
#define BMA400_osr0             0x00  // lowest power, lowest oversampling, lowest accuracy
#define BMA400_osr1             0x01
#define BMA400_osr2             0x02
#define BMA400_osr3             0x03 // highest oversampling, highest power, highest accuracy

//Define accel filter
#define BMA400_acc_filt1        0x00 // variable ODR filter
#define BMA400_acc_filt2        0x01 // fixed 100 Hz ODR filter
#define BMA400_acc_filt_lp      0x02 // fixed 100 Hz ODR filter, 1 Hz BW
