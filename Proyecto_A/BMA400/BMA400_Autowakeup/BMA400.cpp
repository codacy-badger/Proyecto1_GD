...
void BMA400::SetactivitychangeInt(byte Threshold){
  ...
  SPIwriteOneRegister(BMA400_ACTCH_CONFIG1,7<<5|1<<4|0x02); //Enable X,Y,Z axis, set 128 points and data source acc_filt1
  }
...
void BMA400::SetWakeupInterruption(byte threhold) {
  ...
  SPIwriteOneRegister(BMA400_WKUP_INT_CONFIG1, threhold); //  if treshold=5 ->31.25 mg threshold for wake on any axis, n x 6.25 mgs at 2 g FS
