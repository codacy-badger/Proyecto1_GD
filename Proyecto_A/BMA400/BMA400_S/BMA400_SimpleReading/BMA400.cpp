...
// SPIwriteOneRegister(BMA400_AUTOLOWPOW_0, 0xFA);             // set auto low power time out to 10 second
// SPIwriteOneRegister(BMA400_AUTOLOWPOW_1, 0x04);             // switch to low power after time out (max 10.2 sec)
   SPIwriteOneRegister(BMA400_AUTOLOWPOW_1, 0x02);             // switch to low power when GEN1 interrupt triggered

   SPIwriteOneRegister(BMA400_AUTOWAKEUP_1, 0x02);             // enable interrupt for auto wake up
   ...
   SPIwriteOneRegister(BMA400_GEN1INT_CONFIG1, 0x01);       // inactive motion interrupt configuration
