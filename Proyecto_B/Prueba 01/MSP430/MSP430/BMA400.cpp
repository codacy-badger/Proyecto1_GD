...
int16_t BMA400_slaveSelectPin = 10;
...
void BMA400::begin(int16_t chipSelectPin) {
  ...
  BMA400_slaveSelectPin = chipSelectPin;
  pinMode(BMA400_slaveSelectPin, OUTPUT);
  SPI.begin();
...
void BMA400::resetBMA400()
{
  ...
  delayMicroseconds(5);                  // Delay Mycroseconds
...
//  SPIwriteOneRegister(BMA400_ACC_CONFIG0, 0x80 | BMA400_osr3 << 5 | BMA400_normal_Mode);// set bandwidth to 0.2x sample rate, OSR in low-power mode, power mode
//  delay(2);
//  SPIwriteOneRegister(BMA400_ACC_CONFIG1, BMA400_AFS_4G << 6 | BMA400_osr3 << 4 | BMA400_SR_100Hz); // set full-scale range to +/- 4 g
//  SPIwriteOneRegister(BMA400_ACC_CONFIG2, BMA400_acc_filt1 << 2);             // set accel filter
